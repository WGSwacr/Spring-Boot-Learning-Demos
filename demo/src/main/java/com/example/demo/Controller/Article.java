...
public class Article {
    ...
    public String updateArticle(ModelMap map, String id) {
    ...
    public String updateArticleDone(ModelMap map, String id, String content) {
        T_Article t_Article = T_Article.builder().content(content).build();
        int success = articleDaoImplement.addArticle(t_Article);
        map.addAttribute("success", success);
        map.addAttribute("flag", "update");
        return "article";
    ...
    public String deleteArticle(ModelMap map, String id) {
        T_Article t_Article = articleDaoImplement.findArticleById(id);
        map.addAttribute("article", t_Article);
    ...
    public String deleteArticleDone(ModelMap map, String id) {
